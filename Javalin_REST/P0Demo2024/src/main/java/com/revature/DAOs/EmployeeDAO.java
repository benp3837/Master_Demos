...
public class EmployeeDAO implements EmployeeDAOInterface{
    ...
    public ArrayList<Employee> getEmployees() {
        ...
        try(Connection conn = ConnectionUtil.getConnection()){
            ...
            So we'll use a regular Statement object
            If we don't have wildcards/variables, Statement is fine. Otherwise we need PreparedStatement */
            ...
            while(rs.next()){ //rs.next will loop through the ResultSet until there's nothing else to look at
                ...
                Employee e = new Employee(
                        ...
                        null
                        /*there is no ResultSet method for getRole().. we'll add the Role object below*/
                );

                //TODO: set the Role object with a getRole() method in the RoleDAO
        ...
        return null;
        /*why are we returning null at the end?
         All the other returns are in the try/catch block. they are not guaranteed to run.
         So the method needs a fallback return that is guaranteed to run if needed. */
    }
