--Would be pretty convenient to just copy and paste all this in their cliq for them to paste. Save an hour

--CREATE DATABASE shield; (gotta do this before making a new connection of the name shield)
...
INSERT INTO public.avengers (av_name, av_power, first_name, last_name, power_level, home_fk)
